                        ...
                        <div class="header-top-inner">
                            <div class="left-information-area">
                                ...
                                <div class="working-time">
                                    ...
                                    <p>Horários comerciais: 9:00 AM – 8:00 PM</p>
                                </div>
                            </div>
                ...
                <div class="swiper-slide">
                    ...
                    <div class="tmp-banner-area banner-style-five inconstruction tmp-section-gap banner-bg-construction bg_image">
                        ...
                        <div class="shape-image">
                            <img src="{{ asset('assets/images/banner/shape/04.png') }}"src="{{ asset('assets/images/banner/shape/04.png') }}" alt="shape">
                        </div>
                    </div>
                    <!-- tmp banner area end -->
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-thumbnails">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/images/about/8.png') }}"src="{{ asset('assets/images/about/8.png') }}" alt="corporate_business">
        ...
        <div class="container">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner agency-service">
                        <div class="icon">
                            <img src="{{ asset('assets/images/services/agency-7.svg') }}"src="{{ asset('assets/images/services/agency-7.svg') }}" alt="corporate_Business_Services_agency">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner agency-service">
                        <div class="icon">
                            <img src="{{ asset('assets/images/services/agency-8.svg') }}"src="{{ asset('assets/images/services/agency-8.svg') }}" alt="corporate_Business_Services_agency">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner agency-service">
                        <div class="icon">
                            <img src="{{ asset('assets/images/services/agency-9.svg') }}"src="{{ asset('assets/images/services/agency-9.svg') }}" alt="corporate_Business_Services_Agency">
                    ...
                    <div class="single-services">
                        <div class="services-inner">
                            <div class="thumbnail thumbnail-rounded border-top-left hover-animation">
                                <a href="#"><img src="{{ asset('assets/images/services/service-round-1.png') }}"src="{{ asset('assets/images/services/service-round-1.png') }}" alt="Business consulting services"></a>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-blog">
                        <div class="blog-inner">
                            <div class="thumbnail">
                                <a href="{{ route('blog-details') }}"><img src="{{ asset('assets/images/blog/blog-10.png') }}"src="{{ asset('assets/images/blog/blog-10.png') }}" alt="Business Consulting Blog"></a>
                                <div class="pmt-blog-meta">
                                    <ul class="all-meta">
                                        <li class="date"><span>20</span></li>
                                        <li class="month"><span>JAN</span></li>
