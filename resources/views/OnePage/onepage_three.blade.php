...
<!-- tpm-header-area start -->
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="slider-inner">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/images/banner/banner-three.jpg') }}"src="{{ asset('assets/images/banner/banner-three.jpg') }}" alt="marketing consulting">
                        </div>
                        <div class="content">
                            <h2 class="title">
                ...
                <div class="swiper-slide">
                    <div class="slider-inner">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/images/banner/banner-four.jpg') }}"src="{{ asset('assets/images/banner/banner-four.jpg') }}" alt="marketing consulting">
                        </div>
                        <div class="content">
                            <h2 class="title">
                                Start your upcoming modern consulting
                ...
                <div class="swiper-slide">
                    <div class="slider-inner">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/images/banner/banner-five.jpg') }}"src="{{ asset('assets/images/banner/banner-five.jpg') }}" alt="marketing consulting">
                        </div>
                        <div class="content">
                            <h2 class="title">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="about-inner">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/images/about/about-4.jpg') }}"src="{{ asset('assets/images/about/about-4.jpg') }}" alt="about">
                        </div>
                    </div>
                </div>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    ...
                                    <div class="small-meta">
                                        <div class="thumbnail">
                                            <img src="{{ asset('assets/images/about/about-meta.jpg') }}"src="{{ asset('assets/images/about/about-meta.jpg') }}" alt="about-meta">
                                        </div>
                                        <div class="content">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 pl--60 pl_sm--10" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="skill-inner">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/images/about/about-5.jpg') }}"src="{{ asset('assets/images/about/about-5.jpg') }}" alt="about">
                        </div>
                    </div>
            ...
            <div class="row g-5 mt--10">
                <div class="col-lg-6" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="portfolio-inner">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/images/portfolio/potrfolio-10.jpg') }}"src="{{ asset('assets/images/portfolio/potrfolio-10.jpg') }}" alt="corporate business">
                        </div>
                ...
                <div class="col-lg-3" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="portfolio-inner">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/images/portfolio/portfolio-11.jpg') }}"src="{{ asset('assets/images/portfolio/portfolio-11.jpg') }}" alt="corporate business">
                        </div>
                ...
                <div class="col-lg-3" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="portfolio-inner">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/images/portfolio/portfolio-12.jpg') }}"src="{{ asset('assets/images/portfolio/portfolio-12.jpg') }}" alt="business Corporate portfolio">
                        </div>
                        <div class="portfolio-tag bg-gradiant portfolio-sm-tag">
                            <div class="content">
                                <a href="#">
                ...
                <div class="col-lg-3" data-sal-delay="450" data-sal="slide-up" data-sal-duration="800">
                    <div class="portfolio-inner">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/images/portfolio/portfolio-13.jpg') }}"src="{{ asset('assets/images/portfolio/portfolio-13.jpg') }}" alt="business Corporate portfolio">
                        </div>
                        <div class="portfolio-tag bg-gradiant portfolio-sm-tag">
                            <div class="content">
                                <a href="#">
                ...
                <div class="col-lg-3" data-sal-delay="550" data-sal="slide-up" data-sal-duration="800">
                    <div class="portfolio-inner">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/images/portfolio/portfolio-14.jpg') }}"src="{{ asset('assets/images/portfolio/portfolio-14.jpg') }}" alt="business Corporate portfolio">
                        </div>
                        <div class="portfolio-tag bg-gradiant portfolio-sm-tag">
                            <div class="content">
                                <a href="#">
                ...
                <div class="col-lg-6" data-sal-delay="650" data-sal="slide-up" data-sal-duration="800">
                    <div class="portfolio-inner">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/images/portfolio/portfolio-15.jpg') }}"src="{{ asset('assets/images/portfolio/portfolio-15.jpg') }}" alt="corporate business">
                        </div>
                        <div class="portfolio-tag bg-gradiant">
                            <div class="content">
                                <a href="#">
                ...
                <div class="row g-5">
                        ...
                        <div class="tmp-testimonial-box style-three">
                            ...
                            <div class="clint-info-wrapper">
                                <a href="#" class="thumbnail">
                                    <img src="{{ asset('assets/images/testimonial/testimonial-sm-img.png') }}"src="{{ asset('assets/images/testimonial/testimonial-sm-img.png') }}" alt="Corporate Business">
                                </a>
                    ...
                    <div class="col-lg-4">
                        <div class="tmp-testimonial-box style-three">
                            ...
                            <div class="clint-info-wrapper">
                                <a href="#" class="thumbnail">
                                    <img src="{{ asset('assets/images/testimonial/testimonial-sm-img-1.png') }}"src="{{ asset('assets/images/testimonial/testimonial-sm-img-1.png') }}" alt="Corporate Business">
                                </a>
                                <div class="client-info">
                                    <a href="#">
                    ...
                    <div class="col-lg-4">
                        <div class="tmp-testimonial-box style-three">
                            ...
                            <div class="clint-info-wrapper">
                                <a href="#" class="thumbnail">
                                    <img src="{{ asset('assets/images/testimonial/testimonial-sm-img-2.png') }}"src="{{ asset('assets/images/testimonial/testimonial-sm-img-2.png') }}" alt="Corporate Business">
                                </a>
                                <div class="client-info">
                                    <a href="#">
                ...
                <div class="col-lg-12">
                    <div class="main-faq" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="shape-image">
                            <img src="{{ asset('assets/images/faq/03.png') }}"src="{{ asset('assets/images/faq/03.png') }}" alt="business_faq">
                        </div>
                        <div class="row g-0 align-items-center">
                            <div class="col-lg-5">
                                <div class="thumbnail">
                                    <img src="{{ asset('assets/images/faq/faq-img-2.png') }}"src="{{ asset('assets/images/faq/faq-img-2.png') }}" alt="">
                                </div>
                            </div>
    ...
    <div class="quick-action-area quick-action-style-one">
        ...
        <div class="dot-top">
            <div class="thumbnail">
                <img src="{{ asset('assets/images/quick-action/1.png') }}"src="{{ asset('assets/images/quick-action/1.png') }}" alt="dot">
            </div>
        </div>
        <div class="carly-line">
            <div class="thumbnail">
                <img src="{{ asset('assets/images/quick-action/carly-line.png') }}"src="{{ asset('assets/images/quick-action/carly-line.png') }}" alt="">
            </div>
        </div>
        ...
        <div class="shape">
            <div class="thumbnail">
                <img src="{{ asset('assets/images/quick-action//quick-action-1.png') }}"src="{{ asset('assets/images/quick-action//quick-action-1.png') }}" alt="dot">
            </div>
        </div>

        <div class="shape-2">
            <div class="thumbnail">
                <img src="{{ asset('assets/images/quick-action/shape-2.png') }}"src="{{ asset('assets/images/quick-action/shape-2.png') }}" alt="dot">
            </div>
        </div>
