                    ...
                    <div class="main-header-one-wrapper">
                        ...
                        <div class="tmp-nav-area-one header--sticky">
                            <div class="logo-md-sm-device">
                                <a href="#" class="logo">
                                    <img src="{{ asset('assets/images/logo/logo.png') }}"src="{{ asset('assets/images/logo/logo.png') }}" alt="corporate_business-logo">
                                </a>
                            </div>
                    ...
                    <div class="single-services construction">
                        <div class="services-inner">
                            <div class="thumbnail thumbnail-rounded border-top-left hover-animation">
                                <a href="#">
                                    <img src="{{ asset('assets/images/services/service-round-1.png') }}"src="{{ asset('assets/images/services/service-round-1.png') }}" alt="Business consulting services">
