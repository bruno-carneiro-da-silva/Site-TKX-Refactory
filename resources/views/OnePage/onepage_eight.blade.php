            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 order-xl-2 order-md-1 order-sm-1 order-1 mb_md--30 mb_sm--30">
                    <div class="frame-image-about-company">
                        <img src="{{ asset('assets/images/about/about-3.png') }}"src="{{ asset('assets/images/about/about-3.png') }}" alt="Banner Images">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center  plr_sm--15 plr_md--15">
            ...
            <div class="col-lg-6">
                <div class="thumbnail image-right-content">
                    <img src="{{ asset('assets/images/about/about-large.jpg') }}"src="{{ asset('assets/images/about/about-large.jpg') }}" alt="split Images">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-5 counter_animation">
                <div class="col-lg-3 col-md-6 col-sm-6 col-12 counter__anim">
                    <div class="single-counterup-area-agency">
                        <div class="icon">
                            <img src="{{ asset('assets/images/counter/05.svg') }}"src="{{ asset('assets/images/counter/05.svg') }}" alt="agency-service">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12 counter__anim">
                    <div class="single-counterup-area-agency">
                        <div class="icon">
                            <img src="{{ asset('assets/images/counter/08.svg') }}"src="{{ asset('assets/images/counter/08.svg') }}" alt="agency-service">
                        </div>
                        <div class="information">
                            <div class="counter-details">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12 counter__anim">
                    <div class="single-counterup-area-agency">
                        <div class="icon">
                            <img src="{{ asset('assets/images/counter/06.svg') }}"src="{{ asset('assets/images/counter/06.svg') }}" alt="agency-service">
                        </div>
                        <div class="information">
                            <div class="counter-details">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12 counter__anim">
                    <div class="single-counterup-area-agency">
                        <div class="icon">
                            <img src="{{ asset('assets/images/counter/07.svg') }}"src="{{ asset('assets/images/counter/07.svg') }}" alt="agency-service">
                        </div>
                        <div class="information">
                            <div class="counter-details">
                ...
                <div class="col-lg-12">
                    <div class="brand-main-wrapper-company">
                        <div class="tmp-brand-section-start">
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/01.png') }}"src="{{ asset('assets/images/brand/01.png') }}" alt="brand">
                            </a>
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/02.png') }}"src="{{ asset('assets/images/brand/02.png') }}" alt="brand">
                            </a>
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/03.png') }}"src="{{ asset('assets/images/brand/03.png') }}" alt="brand">
                            </a>
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/08.png') }}"src="{{ asset('assets/images/brand/08.png') }}" alt="brand">
                            </a>
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/05.png') }}"src="{{ asset('assets/images/brand/05.png') }}" alt="brand">
                            </a>
                        </div>
                        <div class="tmp-brand-section-start">
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/06.png') }}"src="{{ asset('assets/images/brand/06.png') }}" alt="brand">
                            </a>
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/07.png') }}"src="{{ asset('assets/images/brand/07.png') }}" alt="brand">
                            </a>
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/08.png') }}"src="{{ asset('assets/images/brand/08.png') }}" alt="brand">
                            </a>
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/09.png') }}"src="{{ asset('assets/images/brand/09.png') }}" alt="brand">
                            </a>
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/10.png') }}"src="{{ asset('assets/images/brand/10.png') }}" alt="brand">
                            </a>
                        </div>
                    </div>
