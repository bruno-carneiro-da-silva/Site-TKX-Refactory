                ...
                <div class="col-lg-12">
                    <div class="section-head">
                        <div class="section-sub-title center-title">
                            <img src="{{ asset('assets/images/services/section-custom-menubar.png ') }}" alt="Business Consulting services" style="filter: grayscale(100%) brightness(0%);">
                            <span>NOSSOS SERVIÇOS</span>
                        </div>
                        <h2 class="title split-collab">O que oferecemos</h2>
                    </div>
                </div>
            </div>
