                ...
                <div class="col-lg-6">
                    <div class="about-thumbnail-construction">
                        <div class="image-large">
                            <img src="{{ asset('assets/images/about/about-2.jpg') }}" alt="construction_business">
                        </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-services construction">
                        <div class="services-inner">
                            <div class="thumbnail thumbnail-rounded border-top-left hover-animation">
                                <a href="#"><img src="{{ asset('assets/images/services/services-round-2.png') }}" alt="Business consulting services">
                                    <div class="number-bg-round">
                                        <span>02</span>
                                    </div>
                                </a>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-services construction">
                        <div class="services-inner">
                            <div class="thumbnail thumbnail-rounded border-top-left hover-animation">
                                <a href="#"><img src="{{ asset('assets/images/services/services-round-3.png') }}" alt="Business consulting services">
                                    <div class="number-bg-round">
                                        <span>03</span>
                                    </div>
                            </div></a>
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6 pr--30">
                    <div class="thumbnail-faq-cons">
                        <img src="{{ asset('assets/images/faq/faq-3.jpg') }}" alt="Business Consulting FAQ">
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-12">
                    <div class="large-video-playing grow-thumbnail">
                        <video autoplay="" muted="" loop="" playsinline="" preload="metadata">
                            <source src="{{ asset('assets/images/work/01.mp4') }}" type="video/mp4">
                        </video>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="join-us-one__inner">
                <div class="join-us-one__shape-1">
                    <img src="{{ asset('assets/images/shapes/join-us-one-shape-1.png') }}" alt="">
                </div>
                <div class="join-us-one__shape-2">
                    <img src="{{ asset('assets/images/shapes/join-us-one-shape-2.png') }}" alt="">
                </div>
