...
(function ($) {
    ...
    var tmPk = {
            ...
            $(document).ready(function () {
                ...
                jQuery(window).on("scroll", function () {
                    if (jQuery(this).scrollTop() > offset) {
                        ...
                        jQuery(".support-btn").addClass("active-progress");
                    } else {
                        jQuery(".progress-wrap").removeClass("active-progress");
                        jQuery(".support-btn").removeClass("active-progress");
                    }
                });
                ...
                jQuery("#support-btn").on("click", function (event) {
                    event.preventDefault();
                    toggleChatbot();
                });
            });
        ...
        selectLanguage: function () {
            ...
            Util.cssSupports = function (property, value) {
                if ("CSS" in window) {
                    ...
                    var jsProperty = property.replace(
                        /-([a-z])/g,
                        function (g) {
            ...
            (function () {
                var LanguagePicker = function (element) {
                    ...
                    this.select =
                        this.element.getElementsByTagName("select")[0];
                ...
                function initLanguagePicker(picker) {
                    ...
                    picker.firstLanguage =
                        picker.dropdown.getElementsByClassName(
                ...
                function initLanguagePickerEvents(picker) {
                    ...
                    Util.addClass(
                        picker.trigger.getElementsByTagName("svg")[0],
                        "icon"
                    );
                ...
                function toggleLanguagePicker(picker, bool) {
                    ...
                    if (bool) {
                        ...
                        ariaExpanded =
                            picker.trigger.getAttribute("aria-expanded") ==
                            "true"
                                ? "false"
                                : "true";
                    }
                    ...
                    if (ariaExpanded == "true") {
                        ...
                        picker.dropdown.addEventListener(
                            "transitionend",
                            function cb() {
                                picker.firstLanguage.focus();
                                picker.dropdown.removeEventListener(
                                    "transitionend",
                                    cb
                                );
                            }
                ...
                function initButtonPicker(picker) {
                    ...
                    var customClasses = picker.element.getAttribute(
                        "data-trigger-class"
                    )
                        ? " " +
                    ...
                    var button =
                        ...
                        picker.select.value +
                        " " +
                        picker.element.getElementsByTagName("label")[0]
                            .innerText +
                ...
                function initListPicker(picker) {
                    ...
                    for (var i = 0; i < picker.options.length; i++) {
                        var selected = picker.options[i].hasAttribute(
                                "selected"
                            )
                                ? ' aria-selected="true"'
                                : "",
                ...
                function getSelectedOptionText(picker) {
                    ...
                    if ("selectedIndex" in picker.select) {
                        label =
                            picker.options[picker.select.selectedIndex].text;
                    } else {
                        label =
                            picker.select.querySelector(
                                "option[selected]"
                            ).text;
                    }
                    return label;
                ...
                function initLanguageSelection(picker) {
                    picker.element
                        ...
                        .addEventListener("click", function (event) {
                            var language = event.target.closest(
                                ".language-picker__item"
                            );
                            if (!language) return;
                ...
                var languagePicker =
                    document.getElementsByClassName("js-language-picker");
        ...
        mesonaryIsotop: function () {
            $(window).on("load", function () {
                ...
                if (isotope.length) {
                    ...
                    var buttonGroups =
                        document.querySelectorAll(".tmp-button-group");
        ...
        gsapAnimationImageScale2: function (e) {
            $(document).ready(function () {
                let growActive =
                    document.getElementsByClassName("grow-thumbnail");
                if (growActive.length) {
        ...
        supportChat: function () {
            ...
            const steps = [
                ...
                {
                    question:
                        "Você é uma empresa, transportadora ou operador logístico?",
                    options: [
                        { text: "Embarcador", value: "Truck_Embarcador" },
                        {
                            text: "Transportadora",
                            value: "Truck_Transportadora",
                        },
                        {
                            text: "Operador logístico",
                            value: "Truck_Operador_Logistico",
                        },
                ...
                {
                    question:
                        "Você quer fazer login ou precisa de atendimento?",
                    options: [
                ...
                if (currentStep > 0) {
                    ...
                    if (previousChoice) {
                        const previousStep = steps.find((step) =>
                            step.options.some(
                                (option) => option.value === previousChoice
                            )
                        );
                        if (previousStep) {
    ...
    `);
                ...
                $("body")
                    .off("click", ".send-message-btn")
                    .on("click", ".send-message-btn", function () {
    ...
    `);
                ...
                $("#cnpj").on("input", applyCnpjMask);
                $("#email").on("input", validateEmail);

                $("#name, #email, #phone, #cnpj").each(function () {
